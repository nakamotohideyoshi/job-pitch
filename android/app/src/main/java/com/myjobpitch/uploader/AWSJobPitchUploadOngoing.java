...
public class AWSJobPitchUploadOngoing extends AWSJobPitchUploadBase {

    private final TransferObserver mObserver;
    private final TransferUtility mTransferUtility;
    private boolean mCancelled;

    public AWSJobPitchUploadOngoing(JobPitch pitch, TransferUtility transferUtility, TransferObserver transferObserver) {
        super(pitch);
