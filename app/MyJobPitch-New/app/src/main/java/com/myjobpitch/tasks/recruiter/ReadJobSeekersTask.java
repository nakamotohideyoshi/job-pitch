...
public class ReadJobSeekersTask extends ReadAPITask<List<JobSeeker>> {
    public ReadJobSeekersTask(Integer id) {
        this(id, null);
    }

    public ReadJobSeekersTask(final Integer job_id, final List<Integer> exclude) {
        super(new Action<List<JobSeeker>>() {
            ...
            public List<JobSeeker> run() throws MJPApiException {
                ...
                return MJPApi.shared().get(JobSeeker.class, query);
            }
        });
    }
}
