    ...
    return (
      <div className={styles.root}>
        ...
        <div className="container">
          ...
          <div className="board">
            <div className={[styles.tab, isLoggedIn ? styles.hide : ''].join(' ')}>
              <Link
...

            {
              type === 1 ?
                <div className={styles.content}>
                  <h5>Discover the new age of recruitment – and explore superior calibre candidates at the tap of
                    a few buttons</h5>
                  <p><i>Register</i></p>
                  ...
                  <h5>Pay only when your discover your next hire</h5>
                ...
                <div className={styles.content}>
                  <h5>Welcome to your next job role – here’s where you meet the perfect employer</h5>
                  <p><i>Register</i></p>
                  ...
                  <h5>Seek and discover your hospitality, retail or services position</h5>
