...
function* uploadSpecPitch(action) {
  ...
  try {
    yield call(uploadVideoToAWS, 'application-pitches', newPitch, data, onProgress);
  } catch (error) {
    onFail && onFail();
    return;
  }
