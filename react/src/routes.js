...
export default () => (
  ...
  <Route path="/">
    ...
    <Route getComponent={() => System.import('./components/layout/MainLayout/MainLayout')}>
      <Route path="select" getComponent={() => System.import('./containers/SelectType/SelectType')} />
      <Route path="recruiter">
        ...
        <Route path="messages" getComponent={() => System.import('./containers/Messages/Messages')} />
        <Route path="businesses" getComponent={() => System.import('./containers/recruiter/Businesses/Businesses')} />
        <Route path="credits" getComponent={() => System.import('./containers/recruiter/Credits/Credits')} />
      ...
      <Route path="password" getComponent={() => System.import('./containers/Password/Password')} />
      <Route path="main_about" getComponent={() => System.import('./containers/About/About')} />
      <Route path="main_terms" getComponent={() => System.import('./containers/Terms/Terms')} />
      <Route path="main_privacy" getComponent={() => System.import('./containers/Privacy/Privacy')} />
      <Route path="contactus" getComponent={() => System.import('./containers/ContactUs/ContactUs')} />
    </Route>

    <Route path="*" getComponent={() => System.import('./containers/NotFound/NotFound')} status={404} />
