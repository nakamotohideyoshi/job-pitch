...
class Employee(models.Model):
    ...
    sex = models.ForeignKey(Sex, related_name='employees', null=True, blank=True)
    nationality = models.ForeignKey(Nationality, related_name='employees', null=True, blank=True)
