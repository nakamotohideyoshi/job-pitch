$(function () {
	app(context).then(function () {
		...
		$('#work_place_details').submit(function (event) {
			...
			var work_place_address_public = $('#work_place_address_public').is(':checked');

			var work_place_email = $('#work_place_email').val();
			var work_place_email_public = $('#work_place_email_public').is(':checked');

			var work_place_telephone = $('#work_place_telephone').val();
			var work_place_telephone_public = $('#work_place_telephone_public').is(':checked');

			var work_place_mobile = $('#work_place_mobile').val();
			var work_place_mobile_public = $('#work_place_mobile_public').is(':checked');
